...
### --- KAPALIÇARŞI FİZİKİ ALTIN PİYASASI FORMÜL ENTEGRASYONU ---

### Yalın bankalararası ham spot fiyat yerine Kapalıçarşı makas aralıkları ve prim katsayıları işlenmiştir.

saf_gram = (canli_ons / 31.1034768) * canli_dolar
canli_gram = saf_gram * 1.035 # Fiziki Kapalıçarşı / Serbest piyasa makas primi eklendi
altin_22_ayar = canli_gram * 0.916 * 0.985 # İşçilik maliyetli yerel 22A bilezik karşılığı
